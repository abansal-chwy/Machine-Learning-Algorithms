...
def compare():
    ...
    class_precision=[]
    class_recall=[]
    classifier = [SVC(kernel="linear", C=best_svm),DecisionTreeClassifier(criterion="gini", max_leaf_nodes=best_k_gini),DecisionTreeClassifier(criterion="entropy", max_leaf_nodes=best_k_ig),LinearDiscriminantAnalysis()]
